...
export type NationCode = keyof typeof countryListNumeric;
export const nationCodeList: NationCode[] = Object.keys(countryListNumeric) as NationCode[];
export const nationCodeMap: Record<NationCode, string> = countryListNumeric;
export const nationCodeNameMap: Record<string, NationCode> = Object.fromEntries(
    Object.entries(countryListNumeric).map(([code, name]) => [name, code as NationCode])
);